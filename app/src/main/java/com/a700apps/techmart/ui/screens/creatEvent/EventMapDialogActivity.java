...
/**
 * Created by samir.salah on 11/1/2017.
 */
...
public class EventMapDialogActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener, GoogleMap.OnMapClickListener {
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (innerModle.getLatitude()==null || innerModle.getLongitude() ==null){
                    Toast.makeText(EventMapDialogActivity.this, "Please wait till get your location", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        if (isLocationEnabled(EventMapDialogActivity.this)) {
    ...
    protected void buildGoogleApiClient() {
        ...
        googleApiClient = new GoogleApiClient.Builder(EventMapDialogActivity.this)
    ...
    private void openGpsDialog() {
        if (googleApiClient == null) {
            if (checkGooglePlayServicesAvailable()) {
                if (!isLocationEnabled(EventMapDialogActivity.this)) {
                    googleApiClient = new GoogleApiClient.Builder(EventMapDialogActivity.this).addApi(LocationServices.API)
                            .addConnectionCallbacks(this)
                            ...
                            switch (status.getStatusCode()) {
                                ...
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        status.startResolutionForResult(EventMapDialogActivity.this, 1000);
...
//        super.onBackPressed();
    ...
    private boolean checkGooglePlayServicesAvailable() {
        final int status = GooglePlayServicesUtil.isGooglePlayServicesAvailable(EventMapDialogActivity.this);
        ...
        if (GooglePlayServicesUtil.isUserRecoverableError(status)) {
            final Dialog errorDialog = GooglePlayServicesUtil.getErrorDialog(status, EventMapDialogActivity.this, 1);
            if (errorDialog != null) {
                errorDialog.show();
            }
        }
    ...
    protected void startLocationUpdates() {
        ...
        if (PermissionTool.checkAllPermission(EventMapDialogActivity.this, new String[]{PermissionTool.PERMISSION_LOCATION, PermissionTool.PERMISSION_location_COARSE})) {

        } else {
            PermissionTool.checkAllPermission(EventMapDialogActivity.this, new String[]{PermissionTool.PERMISSION_LOCATION, PermissionTool.PERMISSION_location_COARSE});
        }
    }
...
//        Log.d("last step ", location.getLongitude() + "");
        ...
        Geocoder geocoder = new Geocoder(EventMapDialogActivity.this, Locale.getDefault());
