package com.a700apps.techmart.ui.screens.notification.Ui;
...
import com.a700apps.techmart.ui.screens.notification.FollowView;
import com.a700apps.techmart.ui.screens.notification.NotificationActivity;
import com.a700apps.techmart.ui.screens.notification.NotificationPresenter;
import com.a700apps.techmart.ui.screens.notification.NotificationView;
...
public class NotificationFragment extends Fragment implements NotificationView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv.setAdapter(new NotificationAdapter(getActivity(), null));
        rv.setLayoutManager(new LinearLayoutManager(getActivity()));


        nextTextView = view.findViewById(R.id.textView39);
        previosTextView = view.findViewById(R.id.textView40);

        presenter = new NotificationPresenter();
        presenter.attachView(this);

        if (AppUtils.isInternetAvailable(getActivity())) {
            presenter.loadData(PreferenceHelper.getUserId(getActivity()), currentPage, itemsPerPage);
        } else {
    ...
    public void loadData(List<NoficationData.Result> list) {
        if (list.size() == 0) {
            rv.setEmptyView(view.findViewById(R.id.emptyIndiscator));
        ...
        rv.setAdapter(new NotificationActivity.NotificationAdapter(this, list));
    }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case NOTIF_TYPE_ALARM:
                    ...
                    return new NotificationActivity.NotificationAdapter.DefaultHolder(noteView);
                case NOTIF_TYPE_CONNECT:
                    noteView = inflater.inflate(R.layout.notif_item_connect, parent, false);
                    return new NotificationActivity.NotificationAdapter.ConnectViewHolder(noteView);
                case NOTIF_TYPE_FOLLOW:
                    noteView = inflater.inflate(R.layout.notif_item_follow, parent, false);
                    return new NotificationActivity.NotificationAdapter.FollowViewHolder(noteView);
                case NOTIF_TYPE_POST:
                    noteView = inflater.inflate(R.layout.notif_item_post, parent, false);
                    return new NotificationActivity.NotificationAdapter.PostAddedViewHolder(noteView);
                case NOTIF_TYPE_EVENT:
                    noteView = inflater.inflate(R.layout.notif_item_alarm, parent, false);
                    return new NotificationActivity.NotificationAdapter.EventAddedViewHolder(noteView);
                case NOTIF_TYPE_GROUP_REQUEST:
                    noteView = inflater.inflate(R.layout.notif_item_group_approved, parent, false);
                    return new NotificationActivity.NotificationAdapter.GroupViewHolder(noteView);
                case NOTIF_TYPE_MESSAGE:
                    noteView = inflater.inflate(R.layout.notif_item_new_message, parent, false);
                    return new NotificationActivity.NotificationAdapter.ChatViewHolder(noteView);
...
//            final int itemType = getItemViewType(list.get(position).getTypeID());
            ...
            switch (itemType) {
                ...
                case NOTIF_TYPE_CONNECT:
                    ...
                    NotificationActivity.NotificationAdapter.ConnectViewHolder holder = (NotificationActivity.NotificationAdapter.ConnectViewHolder) viewHolder;
                    ...
                    break;
                case NOTIF_TYPE_FOLLOW:
                    NotificationActivity.NotificationAdapter.FollowViewHolder followViewHolder = (NotificationActivity.NotificationAdapter.FollowViewHolder) viewHolder;
                ...
                case NOTIF_TYPE_POST:
                    ...
                    NotificationActivity.NotificationAdapter.PostAddedViewHolder postAddedViewHolder = (NotificationActivity.NotificationAdapter.PostAddedViewHolder) viewHolder;
...
//                        Log.e("ICON" , MainApi.IMAGE_IP+result.getIcon().toString());
                ...
                case NOTIF_TYPE_EVENT:
                    result = list.get(position);
                    NotificationActivity.NotificationAdapter.EventAddedViewHolder eventAddedViewHolder = (NotificationActivity.NotificationAdapter.EventAddedViewHolder) viewHolder;
                ...
                case NOTIF_TYPE_GROUP_REQUEST:
                    result = list.get(position);
                    NotificationActivity.NotificationAdapter.GroupViewHolder groupViewHolder = (NotificationActivity.NotificationAdapter.GroupViewHolder) viewHolder;
                ...
                case NOTIF_TYPE_MESSAGE:
                    result = list.get(position);
                    NotificationActivity.NotificationAdapter.ChatViewHolder chatViewHolder = (NotificationActivity.NotificationAdapter.ChatViewHolder) viewHolder;
...
//                dialogsLoading = new loadingDialog().showDialog(context);
                connectButton = itemView.view.findViewById(R.id.connectBtn);
                ignoreButton = itemView.view.findViewById(R.id.ignoreBtn);
                profile = itemView.view.findViewById(R.id.imageView14);

                name = itemView.view.findViewById(R.id.nameTv);
                message = itemView.view.findViewById(R.id.messageTv);
...
//            TextView name, message;
            ...
            public PostAddedViewHolder(View itemView) {
                ...
                nameTv = itemView.view.findViewById(R.id.textView15);
                itemNameTv = itemView.view.findViewById(R.id.textView36);
                viewPost = itemView.view.findViewById(R.id.textView37);
                dismiss = itemView.view.findViewById(R.id.imageView16);
                profileImageView = itemView.view.findViewById(R.id.imageView14);
                likeImage = itemView.view.findViewById(R.id.imageView14);
                viewImageView = itemView.view.findViewById(R.id.imageView15);

                likeImage.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_notif_white));
                itemView.view.findViewById(R.id.textView34).setVisibility(View.INVISIBLE);
...
//            TextView name, message;
            ...
            public EventAddedViewHolder(View itemView) {
                ...
                presenter.attachView(this);
                nameTv = itemView.view.findViewById(R.id.textView15);
                itemTimeTv = itemView.view.findViewById(R.id.textView35);
                eventDetailsTv = itemView.view.findViewById(R.id.textView36);
                addToCalenderTv = itemView.view.findViewById(R.id.textView37);
                dismiss = itemView.view.findViewById(R.id.imageView16);
...
//                presenter.attachView(this);
                ...
                viewPost = itemView.view.findViewById(R.id.textView37);
                dismiss = itemView.view.findViewById(R.id.imageView16);
                viewImage = itemView.view.findViewById(R.id.imageView15);
                profileImageView = itemView.view.findViewById(R.id.imageView14);
                followToHide = itemView.view.findViewById(R.id.textView34);
                youToHide = itemView.view.findViewById(R.id.textView35);
//                if (list.get(getAdapterPosition()).getTypeID() == NOTIF_TYPE_SOMEONE_APPROVED_CONNECTION_REQUEST) {
//                    itemView.view.findViewById(R.id.textView34).setVisibility(View.INVISIBLE);
//                    itemView.view.findViewById(R.id.textView35).setVisibility(View.INVISIBLE);
//                }
                viewPost.setOnClickListener(this);
                dismiss.setOnClickListener(this);
...
//                presenter.attachView(this);
                ...
                descriptionTv = itemView.view.findViewById(R.id.descriptionTv);
                messageTv = itemView.view.findViewById(R.id.messageTv);
                viewPost = itemView.view.findViewById(R.id.viewTv);
...
//                presenter.attachView(this);
                ...
                messageTv = itemView.view.findViewById(R.id.messageTv);
                viewPost = itemView.view.findViewById(R.id.viewTv);
                imageView15 = itemView.view.findViewById(R.id.imageView15);
