 ...
 */
public class FragmentTomorrow extends Fragment implements MettingView , UpdateFirstItem{
    private MettingPressenter presenter;
    private RecyclerView schedualTomorrowList;
    ...
    private String currentDay, tomorrowDay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_tomorrow, container, false);
    }
    ...
    private void findViews(View view) {
        schedualTomorrowList = (RecyclerView) view.findViewById(R.id.recyclerView);
        ...
        schedualTomorrowList.setLayoutManager(new LinearLayoutManager(getActivity()));
        findCustomView(view);
        getDate();
        presenter.getSchedual(getActivity(), PreferenceHelper.getUserId(getActivity()), currentDay, tomorrowDay);
    ...
    private void getDate() {
        ...
        tomorrowDay = _currentYear + "-" + _currentMonth + "-" + _currentDay;
        Log.e("tomorrowDay", tomorrowDay);
    }
    ...
    public void drawUiData(List<AllSchedualList.ResultEntity> schedualList) {
        ...
        schedualTomorrowList.setAdapter(mettingDaysAdapter);
