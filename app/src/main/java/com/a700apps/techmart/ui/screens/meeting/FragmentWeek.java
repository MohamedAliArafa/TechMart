 ...
 */
public class FragmentWeek extends Fragment implements MettingView, UpdateFirstItem {
    private MettingPressenter presenter;
    private RecyclerView schedualWeekList;
    ...
    private String currentDay, dayAfterWeek;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getDate();
        presenter.getSchedual(getActivity(), PreferenceHelper.getUserId(getActivity()), currentDay, dayAfterWeek);
    ...
    private void findViews(View view) {
        schedualWeekList = (RecyclerView) view.findViewById(R.id.recyclerView);
        ...
        schedualWeekList.setLayoutManager(new LinearLayoutManager(getActivity()));
        findCustomView(view);
    ...
    private void getDate() {
        ...
        dayAfterWeek = _currentYear + "-" + _currentMonth + "-" + _currentDay;
        Log.e("dayAfterWeek", dayAfterWeek);
    }
    ...
    public void drawUiData(List<AllSchedualList.ResultEntity> schedualList) {
        ...
        schedualWeekList.setAdapter(mettingDaysAdapter);
    }
