...
public class NotificationFragment extends Fragment implements NotificationView {
    ...
    public void loadData(List<NoficationData.Result> list) {
        ...
        rv.setAdapter(new NotificationAdapter(getActivity(), list));
    }
...
//            final int itemType = getItemViewType(list.get(position).getTypeID());
            ...
            switch (itemType) {
                ...
                case NOTIF_TYPE_CONNECT:
                    ...
                    NotificationAdapter.ConnectViewHolder holder = (NotificationAdapter.ConnectViewHolder) viewHolder;
                    ...
                    break;
                case NOTIF_TYPE_FOLLOW:
                    NotificationAdapter.FollowViewHolder followViewHolder = (NotificationAdapter.FollowViewHolder) viewHolder;
                ...
                case NOTIF_TYPE_POST:
                    ...
                    NotificationAdapter.PostAddedViewHolder postAddedViewHolder = (NotificationAdapter.PostAddedViewHolder) viewHolder;
...
//                        Log.e("ICON" , MainApi.IMAGE_IP+result.getIcon().toString());
                ...
                case NOTIF_TYPE_EVENT:
                    result = list.get(position);
                    NotificationAdapter.EventAddedViewHolder eventAddedViewHolder = (NotificationAdapter.EventAddedViewHolder) viewHolder;
                ...
                case NOTIF_TYPE_GROUP_REQUEST:
                    result = list.get(position);
                    NotificationAdapter.GroupViewHolder groupViewHolder = (NotificationAdapter.GroupViewHolder) viewHolder;
                ...
                case NOTIF_TYPE_MESSAGE:
                    result = list.get(position);
                    NotificationAdapter.ChatViewHolder chatViewHolder = (NotificationAdapter.ChatViewHolder) viewHolder;
